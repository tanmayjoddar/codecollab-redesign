...
import { Loader2, ArrowRight, Github, Mail, Sparkles, Code2, Users, Zap } from "lucide-react";
...
function FeatureHighlight({ icon: Icon, text, delay }: { icon: React.ElementType; text: string; delay: number }) {
  return (
    <motion.div
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col lg:flex-row overflow-hidden relative">
      ...
      <FloatingOrb className="w-[500px] h-[500px] bg-violet-600 -top-48 -left-48" delay={0} />
      <FloatingOrb className="w-[400px] h-[400px] bg-cyan-600 top-1/3 right-0" delay={2} />
      <FloatingOrb className="w-[300px] h-[300px] bg-rose-600 bottom-0 left-1/4" delay={4} />
        ...
        <div className="max-w-xl w-full">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-lg">
              The collaborative code editor that brings your team together. Write, execute, and debug code in real-time with developers worldwide.
            </p>
          </motion.div>
          ...
          >
            <FeatureHighlight icon={Code2} text="Support for 10+ programming languages" delay={0.4} />
            <FeatureHighlight icon={Users} text="Real-time collaboration with live cursors" delay={0.5} />
            <FeatureHighlight icon={Zap} text="Instant code execution in secure sandboxes" delay={0.6} />
          </motion.div>
          ...
          >
            ...
            <div className="font-mono text-sm space-y-2">
              <div className="flex">
                ...
                <span><span className="text-violet-400">const</span> <span className="text-cyan-400">team</span> = <span className="text-amber-400">"awesome"</span>;</span>
              </div>
              <div className="flex">
                <span className="text-muted-foreground/50 w-8">2</span>
                <span><span className="text-violet-400">const</span> <span className="text-cyan-400">code</span> = <span className="text-emerald-400">collaborate</span>();</span>
              </div>
              <div className="flex items-center">
                <span className="text-muted-foreground/50 w-8">3</span>
                <span className="flex items-center gap-2">
                  <span className="text-violet-400">return</span> <span className="text-cyan-400">magic</span>;
                  <motion.span
